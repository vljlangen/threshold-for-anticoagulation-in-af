...
# muuta yllä olevan nimi vastaamaan nykyisiä file nameja.
# tämähän oli alun perin res_all_ver2.rds 
# ja löytyy hakemistosta eckmann

save.prefix <- "figures/figure_S6"
...
############################################################################
##                                Figure:                                 ##
##            Probability that DOAC therapy leads to more QALYs           ##
...
p <- ggplot(confidences.df, aes(x = isRisk, y = prob)) +
  ...
  ggtitle("Probability that DOAC therapy leads to more QALYs\nthan withholding treatment in the probabilistic sensitivity analysis\n") +
